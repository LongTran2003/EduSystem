...
namespace EduSystem.DataAccess.Repositories
{
    public class QuestionRepository : Repository<Question>, IQuestionRepository
    {
        ...
        public async Task<(List<Question> questions, int totalQuestions)> GetQuestionsByCurrentTeacherAsync(
            Guid teacherId,
            int pageNumber,
            int pageSize,
            string? filterOn,
            ...
            string? includeProperties = null)
        {
            var query = _context.Questions
                ...
                .Where(q => q.TeacherId == teacherId && q.Status != StaticOperationStatus.BaseEntity.Deleted)
                .AsQueryable();
